...
export class CanvistEditor {
     ...
     */
    anchor_count_after_offset(offset: number, inclusive: boolean): number;
    /**
     ...
     */
    anchor_count_before_offset(offset: number, inclusive: boolean): number;
    /**
     ...
     */
    anchor_distance_between(first_name: string, second_name: string): number;
    /**
     * Distance from a named anchor to an offset.
     *
     * Returns -1 when the anchor does not exist.
     */
    anchor_distance_from_offset(name: string, offset: number): number;
    /**
     ...
     */
    anchor_names_between(start_name: string, end_name: string, inclusive: boolean): string[];
    /**
     ...
     * Output is sorted by offset then name.
     */
    anchor_names_in_offset_window(center_offset: number, radius: number): string[];
    /**
     ...
     * Returns empty when either anchor name is missing.
     */
    anchor_span_offsets(start_name: string, end_name: string): Uint32Array;
    /**
     ...
     */
    closest_anchor_to_offset(offset: number): string[];
    /**
     ...
     */
    line_occurrence_average_group_size_in_count_range(case_sensitive: boolean, ignore_whitespace: boolean, min_count: number, max_count: number): number;
    /**
     ...
     */
    line_occurrence_group_count_in_count_range(case_sensitive: boolean, ignore_whitespace: boolean, min_count: number, max_count: number): number;
    /**
     * Number of line-content groups with an occurrence size exactly `count`.
     */
    line_occurrence_group_count_with_count(case_sensitive: boolean, ignore_whitespace: boolean, count: number): number;
    /**
     ...
     * count descending.
     */
    line_occurrence_histogram_in_count_range(case_sensitive: boolean, ignore_whitespace: boolean, min_count: number, max_count: number): Uint32Array;
    /**
     * Number of lines belonging to groups constrained to an inclusive count range.
     */
    line_occurrence_line_count_in_count_range(case_sensitive: boolean, ignore_whitespace: boolean, min_count: number, max_count: number): number;
    /**
     ...
     */
    line_occurrence_lines_in_count_range(case_sensitive: boolean, ignore_whitespace: boolean, min_count: number, max_count: number): Uint32Array;
    /**
     ...
     */
    line_occurrence_lines_with_max_count(case_sensitive: boolean, ignore_whitespace: boolean, max_count: number): Uint32Array;
    /**
     * All line numbers belonging to groups with at least `min_count` occurrences.
     */
    line_occurrence_lines_with_min_count(case_sensitive: boolean, ignore_whitespace: boolean, min_count: number): Uint32Array;
    /**
     * Maximum group size constrained to an inclusive occurrence-count range.
     *
     * Returns 0 when there are no groups in range.
     */
    line_occurrence_max_group_size_in_count_range(case_sensitive: boolean, ignore_whitespace: boolean, min_count: number, max_count: number): number;
    /**
     * Minimum group size constrained to an inclusive occurrence-count range.
     *
     * Returns 0 when there are no groups in range.
     */
    line_occurrence_min_group_size_in_count_range(case_sensitive: boolean, ignore_whitespace: boolean, min_count: number, max_count: number): number;
    /**
     ...
     */
    line_occurrence_rankings(case_sensitive: boolean, ignore_whitespace: boolean, min_count: number): Uint32Array;
    /**
     * Ranked line-occurrence groups constrained to an inclusive count range.
     *
     * Returns flat `[line, count, ...]`, preserving ranking order.
     */
    line_occurrence_rankings_in_count_range(case_sensitive: boolean, ignore_whitespace: boolean, min_count: number, max_count: number): Uint32Array;
    /**
     ...
     */
    most_common_line_occurrence_count(case_sensitive: boolean, ignore_whitespace: boolean): number;
    /**
     * Line numbers in the most common line-content group.
     *
     * Ties are broken by lowest first line, then lexicographic line list.
     */
    most_common_line_occurrence_lines(case_sensitive: boolean, ignore_whitespace: boolean): Uint32Array;
    /**
     ...
     */
    remove_anchors_after_offset(offset: number, inclusive: boolean): number;
    /**
     * Remove anchors before an offset.
     *
     * Returns number removed.
     */
    remove_anchors_before_offset(offset: number, inclusive: boolean): number;
    /**
     ...
     * Returns number removed.
     */
    remove_anchors_in_offset_window(center_offset: number, radius: number): number;
    /**
     ...
     * Offsets are clamped to document bounds. Returns number shifted.
     */
    shift_anchors_after_offset(offset: number, delta: number, inclusive: boolean): number;
    /**
     ...
     * Offsets are clamped to document bounds. Returns number shifted.
     */
    shift_anchors_before_offset(offset: number, delta: number, inclusive: boolean): number;
    /**
     ...
     * Offsets are clamped to document bounds. Returns number shifted.
     */
    shift_anchors_in_offset_window(center_offset: number, radius: number, delta: number): number;
    /**
...
export interface InitOutput {
    ...
    readonly canvisteditor_anchor_count_after_offset: (a: number, b: number, c: number) => number;
    ...
    readonly canvisteditor_anchor_span_offsets: (a: number, b: number, c: number, d: number, e: number) => [number, number];
    ...
    readonly canvisteditor_line_occurrence_average_group_size_in_count_range: (a: number, b: number, c: number, d: number, e: number) => number;
    ...
    readonly canvisteditor_line_occurrence_lines_with_max_count: (a: number, b: number, c: number, d: number) => [number, number];
    readonly canvisteditor_line_occurrence_lines_with_min_count: (a: number, b: number, c: number, d: number) => [number, number];
    readonly canvisteditor_line_occurrence_max_group_size_in_count_range: (a: number, b: number, c: number, d: number, e: number) => number;
    readonly canvisteditor_line_occurrence_min_group_size_in_count_range: (a: number, b: number, c: number, d: number, e: number) => number;
    ...
    readonly canvisteditor_line_occurrence_rankings_in_count_range: (a: number, b: number, c: number, d: number, e: number) => [number, number];
    ...
    readonly canvisteditor_most_common_line_occurrence_count: (a: number, b: number, c: number) => number;
    readonly canvisteditor_most_common_line_occurrence_lines: (a: number, b: number, c: number) => [number, number];
    ...
    readonly canvisteditor_shift_anchors_after_offset: (a: number, b: number, c: number, d: number) => number;
